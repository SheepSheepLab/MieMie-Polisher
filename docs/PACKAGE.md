...
```json
{
  ...
  "asset": {
    "name": "MieMie-Polisher-Extension-1.1.1.json",
    "size": 0,
...
所有新版本只使用 `MAJOR.MINOR.PATCH`。1.1.0 新增独立 Launcher 和 Hub 自动收纳；1.1.1 仅替换正式 Icon 并提升 PATCH。保留 1.1.0 Release 作为真实更新测试基线。
