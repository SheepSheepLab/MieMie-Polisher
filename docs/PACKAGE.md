...
```json
{
  ...
  "asset": {
    "name": "MieMie-Polisher-Extension-1.1.0.json",
    "size": 0,
...
所有新版本只使用 `MAJOR.MINOR.PATCH`。1.1.0 新增独立 Launcher 和 Hub 自动收纳，因此提升 MINOR；当前 Icon 未收到修正版，保持原素材。历史 1.0.1 可作为旧版更新测试基线，不制造带虚假新 Icon 的 1.0.2。
